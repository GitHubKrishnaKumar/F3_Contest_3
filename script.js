...
const checkUsername = () => {
    ...
    if (!isRequired(username)) {
        ...
        showError(usernameEl,"Name should at least be 2 letter word");
    }
    else {
...
const data = [];//store data in array
...
form.addEventListener('submit', function (e) {
    ...
    if(isFormValid) {
        ...
        console.log(isFormValid,"fgxgxweweqweqeqwqfdgxdf");
        document.querySelector('.msg').innerHTML = "Error in Signup page";
    }
});
